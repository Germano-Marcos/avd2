const { Prova3: Prova3Model } = require("../models/Prova3");

const prova3Controller = {
    create: async (req, res) => {
        try {
            ...
            const response = await Prova3Model.create(prova3);
    ...
    getAll: async (req, res) => {
        try {
            const provas = await Prova3Model.find();
    ...
    get: async (req, res) => {
        try {
          ...
          const prova3 = await Prova3Model.findById(id);
      ...
      delete: async (req, res) => {
        try {
          ...
          const deletedProva3 = await Prova3Model.findByIdAndDelete(id);
    
          res
            .status(200)
            .json({ deletedProva3, msg: "Prova excluída com sucesso!" });
        } catch (error) {
          console.log(error);
        }
      },
...
module.exports = prova3Controller