const { Prova2: Prova2Model } = require("../models/Prova2");

const prova2Controller = {
    create: async (req, res) => {
        try {
            ...
            const response = await Prova2Model.create(prova2);
    ...
    get: async (req, res) => {
        try {
          ...
          const prova2 = await Prova2Model.findById(id);
      ...
      delete: async (req, res) => {
        try {
          ...
          const deletedProva2 = await Prova2Model.findByIdAndDelete(id);
    
          res
            .status(200)
            .json({ deletedProva2, msg: "Prova excluída com sucesso!" });
        } catch (error) {
          console.log(error);
        }
      },
...
module.exports = prova2Controller